...
{
    /// <summary>
    /// Client for the APIVerve.API.Permutation&CombinationCalculator API
    /// </summary>
    public class Permutation&CombinationCalculatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        ...
        public Permutation&CombinationCalculatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public Permutation&CombinationCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public Permutation&CombinationCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, Permutation&CombinationCalculatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        public ResponseObj Execute(Permutation&CombinationCalculatorQueryOptions options = null)
        {
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        public Task<ResponseObj> ExecuteAsync(Permutation&CombinationCalculatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(Permutation&CombinationCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(Permutation&CombinationCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(Permutation&CombinationCalculatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(Permutation&CombinationCalculatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(Permutation&CombinationCalculatorQueryOptions options)
        {
