...
namespace APIVerve.API.PermutationCombinationCalculator
{
    ...
    /// <summary>
    /// Client for the PermutationCombinationCalculator API
    /// </summary>
    public class PermutationCombinationCalculatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/permutationcombination";
        ...
        {
            { "n", new ValidationRule { Type = "integer", Required = true, Min = 0, Max = 170 } },
            { "r", new ValidationRule { Type = "integer", Required = true, Min = 0, Max = 170 } }
        };
        ...
        public PermutationCombinationCalculatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PermutationCombinationCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PermutationCombinationCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, PermutationCombinationCalculatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(PermutationCombinationCalculatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(PermutationCombinationCalculatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(PermutationCombinationCalculatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(PermutationCombinationCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(PermutationCombinationCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(PermutationCombinationCalculatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(PermutationCombinationCalculatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(PermutationCombinationCalculatorQueryOptions options)
        {
