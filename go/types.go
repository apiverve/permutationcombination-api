// Package permutationcombination provides a Go client for the Permutation & Combination Calculator API.
//
// For more information, visit: https://apiverve.com/marketplace/permutationcombination?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Permutation & Combination Calculator API.
//
// Parameters:
//   - n (required): integer - Total number of items [min: 0, max: 170]
//   - r (required): integer - Number of items to choose (must be <= n) [min: 0, max: 170]
type Request struct {
	N int `json:"n"` // Required
	R int `json:"r"` // Required
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"n": {Type: "integer", Required: true, Min: float64Ptr(0), Max: float64Ptr(170)},
		"r": {Type: "integer", Required: true, Min: float64Ptr(0), Max: float64Ptr(170)},
	}
...
// ResponseData contains the data returned by the Permutation & Combination Calculator API.
...
// FormulasData represents the formulas object.
type FormulasData struct {
