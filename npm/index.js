...
class permutationcombinationWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/permutationcombination');
        }
        ...
        this.validationRules = {"n":{"type":"integer","required":true,"min":0,"max":170},"r":{"type":"integer","required":true,"min":0,"max":170}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/permutationcombination`);
        }
    }
...
module.exports = permutationcombinationWrapper;
